...
struct AMDGPUDeviceTy : public GenericDeviceTy, AMDGenericDeviceTy {
  ...
  doJITPostProcessing(std::unique_ptr<MemoryBuffer> MB) const override {
    ...
    SmallVector<char, 128> LinkerOutputFilePath;
    ...
    SmallVector<char, 128> LinkerInputFilePath = LinkerOutputFilePath;
    LinkerInputFilePath.pop_back_n(2);

    auto FD = llvm::raw_fd_ostream(LinkerInputFilePath.data(), EC);
    if (EC)
